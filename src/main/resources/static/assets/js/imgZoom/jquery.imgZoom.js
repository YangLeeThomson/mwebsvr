                ...
                img.onload = function() {
                    ...
                    if (img.width > img.height) {
                        ...
                        style = "z-index:6666;position:absolute;top:" +
                            ...
                            "px;margin-left:-" +
                            displayWidth / 2 +
                            "px;cursor:pointer;background:#fff";
                        ...
                        style = "z-index:6666;position:absolute;width:1000px;top:" +
                            windowHeight / 2 +
                            "px;margin-top:-" +
                            displayHeight / 2 +
                            "px;left:50%;margin-left:-500px;cursor:pointer;background:#fff;";
                        dom = "<div style='"+style+"'><img draggable='true' style='width:100%'  src = '" +
                            src +
                            "'  id='imgZoomImg'></div>";
                    }
                    $("body").append(dom);
