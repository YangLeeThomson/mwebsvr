...
(function() {
    ...
    f = {
        ...
        hotTemplate: {
            ...
            title: '<div class="address_hotcity"><strong>\u70ed\u95e8\u5355\u4f4d</strong>{$text}</div>',
        ...
        function S() {
            ...
            for (b in f.hotData) { // b:tab头标题
				...
				if(i!=0){
					...
					li_item += "<div style='margin-left:5px; color:#F44336'>"+b+"</div>" + c;
					if(item_len%8 != 0){
            ...
            if (f.hotData) {
                ...
                var a = f.hotTemplate.container.replaceWith({
                    text: [f.hotTemplate.title.replaceWith({
                        text: $$.module.address.source[o.source + "_keyWord"] || " \uff08\u53ef\u76f4\u63a5\u8f93\u5165\u5355\u4f4d\u6216\u5355\u4f4d\u62fc\u97f3\uff09"
        ...
        function L() {
            ...
            f.hotTarget = u;
                ...
                if (a) {
                    ...
                    p.style.backgroundColor = arr.length ? "#F44336": "#F44336";
                    if (!arr || !arr.length) {
...
//			A="@Renminwang|人民网|23|@Xinhuawang|新华网|21|@Zhongguoxinwenwang|中国新闻网|2475|@Tengxun|腾讯|16|@Xinlang|新浪|17|@Wangyi|网易|18|@Souhu|搜狐|19|@GuanGminGwanG|光明网|32|@Shangwubu|商务部|40|@Xinlangweibo|新浪微博|44|@Caixinwang|财新网|124|@Baidu|百度|2448|@Zhongguoribaowang|中国日报网|2480|@"
		}	
