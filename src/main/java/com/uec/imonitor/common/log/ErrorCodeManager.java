...
//	private static final String defaultValue = "Unknown Error.";
	
//	private static Properties p = new Properties();
//	
//	static {
//		try {
//			p.load(ErrorCodeManager.class.getResourceAsStream("/errorcode.properties"));
//		} catch (FileNotFoundException e) {
//			log.error("resource file does not exist");
//		} catch (IOException e) {
//			log.error("resource file loading failure");
//		}
//	}
