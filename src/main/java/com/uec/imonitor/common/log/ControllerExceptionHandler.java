...
public class ControllerExceptionHandler extends BaseController{
	 ...
	 */
	@ModelAttribute
	public void getPageConfig(@PathVariable(required=false) String tenantMark,Model model,HttpServletRequest request,HttpServletResponse response,HttpSession session) throws BaseException, Exception{
