...
public class PeoplesDailyController extends BaseController {
	...
	*/
	...
	public ModelMap pagePeopleNews(DataTablesRequestEntity aoData) throws  Exception{
	...
	public ModelMap peoplesDailyDetail(String webpageCode) throws  Exception{
	...
	public ModelMap peoplesDailyOperal(String webpageCode) throws  Exception{
	...
	public ModelMap verifyArticle(String webpageCode) throws  Exception{
		ModelMap map = new ModelMap();
