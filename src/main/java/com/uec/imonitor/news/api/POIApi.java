...
public class POIApi extends BaseController{
	...
	public String exportexcel(String selectedData,String fileName,String startTime,String endTime) throws BaseException,Exception {
	...
	@RequestMapping(value = "/latestReprint",method = RequestMethod.GET)
		public String latestReprint(String selectedData,String fileName,String startTime,String endTime
				,Integer reprintType,Integer status) throws BaseException,Exception {
...
//			param.setSortType("desc");
	...
	@RequestMapping(value = "/articlereprintpio",method = RequestMethod.GET)
		public String articlereprintpio(String selectedData,String fileName,String startTime,String endTime
				,Integer reprintType,Integer status,Integer newsId) throws BaseException,Exception {
	...
	@RequestMapping(value = "/unitrepropoi",method = RequestMethod.GET)
		public String unitrepropoi(String selectedData,String fileName,String startTime,String endTime
				,Integer reprintType,Integer status,String sourceCrawl) throws BaseException,Exception {
...
//			}
	...
	public ModelMap getCompnaySource() throws BaseException,Exception{
		...
		for (WebsiteDicEntity websiteDicEntity : websiteDicEntities) {
			buffer.append("@").append(py4j.getPinyin(websiteDicEntity.getName())).append("|")
			.append(websiteDicEntity.getName()).append("|").append(websiteDicEntity.getWebsiteId()).append("|")
			.append(py4j.stringChange(websiteDicEntity.getName())).append("|");
		}
