...
public class NewsApi extends BaseController{
	...
	public ModelMap pageReprintNews(DataTablesRequestEntity aoData,Integer newsId,QueryNewsParam param, Model model) throws BaseException,Exception {
...
//		}
	...
	public ModelMap pageRequestNews(DataTablesRequestEntity aoData,QueryNewsParam param, Model model) throws BaseException,Exception {
	...
	public ModelMap reprintWebsiteRanking(QueryNewsParam param, Model model) throws BaseException,Exception {
		//获取所有被监控的新闻
		param.setPageStart(0);
		param.setPageSize(10000);
		if(null != param.getEndTime()){
...
//		param.setEndTime(null);
	...
	public ModelMap tortWebsiteRanking(QueryNewsParam param,Integer newsId, Model model) throws BaseException,Exception {
		List<Integer> newsIds = null;
		if(null != newsId){
			newsIds = new ArrayList<Integer>();
			newsIds.add(newsId);
...
//		param.setNewsIds(newsIds);
	...
	public ModelMap tortRatio(QueryNewsParam param,Integer newsId, Model model) throws BaseException,Exception {
		List<Integer> newsIds = null;
		if(null != newsId){
			newsIds = new ArrayList<Integer>();
			newsIds.add(newsId);
...
//		param.setNewsIds(newsIds);
	...
	public ModelMap findNewsWebpage(String webpageCode,Integer newsId, Model model) throws BaseException,Exception {
	...
	public ModelMap findRequestNews(Integer newsId, Model model) throws BaseException,Exception {
	...
	public ModelMap companyReprintSectionRanking(QueryNewsParam param, Model model) throws BaseException,Exception {
		param.setPageStart(0);
		param.setPageSize(10000);
		List<Integer> newsIds = null;
	...
	public ModelMap listRequestNewsCode(QueryNewsParam param, Model model) throws BaseException,Exception {
		param.setPageStart(0);
		param.setPageSize(10000);
	...
	public ModelMap getLatestUpdateTime(QueryNewsParam param, Model model) throws BaseException,Exception {
		Date time = null;
		param.setPageStart(0);
		param.setPageSize(1);
	...
	public ModelMap listReprintType(Model model) throws BaseException,Exception {
		Map<Integer, String> map = ConstantUtil.REPRINT_TYPE_MAP;
		return super.getModelMap(map);
	}
	
	/**
	 * <br/>Description:获取转载状态列表
	 * <p>Author:xpguo/郭晓鹏</p>
	 * @param model
	 * @return
	 * @throws BaseException
	...
	public ModelMap listReprintTypeStatus(Model model) throws BaseException,Exception {
		Map<Integer, String> map = ConstantUtil.REPRINT_STATUS_MAP;
		return super.getModelMap(map);
	}
	
	/**
	 * <br/>Description:按时间统计该新闻的被转载数
	 * <p>Author:xpguo/郭晓鹏</p>
	 * @param param
	 * @param newsId
	 * @param model
	...
	public ModelMap reprintNumRanking(QueryNewsParam param,Integer newsId, Model model) throws BaseException,Exception {
	...
	public ModelMap reprintTypeRatio(QueryNewsParam param,Integer newsId, Model model) throws BaseException,Exception {
		List<Integer> newsIds = null;
		if(null != newsId){
			newsIds = new ArrayList<Integer>();
			newsIds.add(newsId);
